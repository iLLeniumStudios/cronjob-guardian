...
# tools. (i.e. podman)
# Auto-detect: use podman if docker is not available
...
GO_CMD_PATHS := ./api/... ./cmd/... ./internal/... ./test/...
...
KIND_CLUSTER ?= cronjob-guardian-test-e2e
...
docker-buildx: ## Build and push docker image for the manager for cross-platform support
	...
	- $(CONTAINER_TOOL) buildx create --name cronjob-guardian-builder
	$(CONTAINER_TOOL) buildx use cronjob-guardian-builder
	- $(CONTAINER_TOOL) buildx build --push --platform=$(PLATFORMS) --tag ${IMG} -f Dockerfile.cross .
	- $(CONTAINER_TOOL) buildx rm cronjob-guardian-builder
	rm Dockerfile.cross
